...
public class StoreRestController {
    ...
    public ApiResponse<MissionResponseDto.MissionPreViewListDto> getMissionList(@ExistStores @PathVariable(name = "storeId") Long storeId, @PageValid @RequestParam(name = "page") Integer page){
