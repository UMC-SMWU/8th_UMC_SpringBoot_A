...
public class MissionCommandServiceImpl implements MissionCommandService {
    ...
    @Override
    public MemberMission completeMission(MemberMissionRequestDto.UpdateMemberMissionDto request) {
        MemberMission memberMission = memberMissionRepository.findByMemberIdAndMissionId(request.getMemberId(),request.getMissionId())
