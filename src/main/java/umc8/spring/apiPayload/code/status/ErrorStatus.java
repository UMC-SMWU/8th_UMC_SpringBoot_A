package umc8.spring.apiPayload.code.status;

import lombok.AllArgsConstructor;
import lombok.Getter;
import org.springframework.http.HttpStatus;
import umc8.spring.apiPayload.code.BaseErrorCode;
import umc8.spring.apiPayload.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.BAD_REQUEST, "MEMBER4004", "유효하지 않은 비밀번호입니다."),
    ...
    // 식당
    STORE_NOT_FOUND(HttpStatus.BAD_REQUEST, "STORE4001", "식당을 찾을 수 없습니다."),
    // 지역
